...
namespace IntegradorP.Controllers
{
    public class Reservas1Controller : Controller
    {
        ...
        public Reservas1Controller(BaseDatosProyectoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ReservaId,Fecha,HoraInicio,HoraFin,UsuarioId,Precio,InstalacionId,ValorTotalReserva")] Reserva reserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservaId,Fecha,HoraInicio,HoraFin,UsuarioId,Precio,InstalacionId,ValorTotalReserva")] Reserva reserva)
        {
